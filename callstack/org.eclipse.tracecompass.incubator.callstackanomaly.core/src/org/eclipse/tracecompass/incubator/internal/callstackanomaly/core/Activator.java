...
package org.eclipse.tracecompass.incubator.internal.callstackanomaly.core;
...
public class Activator extends TraceCompassActivator {
    ...
    /** The plug-in ID */
    public static final String PLUGIN_ID = "org.eclipse.tracecompass.incubator.callstackanomaly.core"; //$NON-NLS-1$
